...
The goal of `mrpviz` is to assist authors of a Multiple Regression Poststratification
edited book in creating visualizations that are readable, cohesive, and accessible.

## Installation

You can install the `mrpviz` package from [GitHub](https://github.com/) with:
...
These are basic plot examples of `mrpviz` colour palettes using 
`mtcars` dataset:
