...
This project relates to an edited book related to multilevel regression and 
poststratification (MRP). As is the case with other books, there will be
numerous visualisations used in this book. These plots will need to be both
...
(in this case, authors) to just add a theme and a color scale function to their
plots. This is easy to use, and it will cause minimal disruptions to authors'
work. More importantly, this will allow the book to have visualizations that are
...
data visualisations, and describe the methods of choosing color palettes for
...
are seen as seen by deutan, protan, and tritan color-blind.

### Qualitative Palettes (200)
...
he four colors in this palette maintain the same chroma and luminance, and 
