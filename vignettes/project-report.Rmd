...
```{r qualitative, fig.height=3, fig.cap="HCL colour spectrum plot for Quokka and Quoll palette. The hues, chroma, and luminance vary across the four colours for Quokka and Quoll palettes. These varying hues, chroma and luminance avoid natural ordering.",fig.subcap=c("",""), fig.ncol = 1}
