...
confused or distracted from the data. Some examples of chartjunk are moiré 
...
how human color perception works. It was found that human color vision evolved 
...
of this plane [@zeileis2006choosing]:

1. Hue: dominant wavelength
2. Chroma: colorfulness
3. Luminance: brightness

Unfortunately, not every software packages use color space developed based on
human perception. For example, the most common color map used by software 
packages is Red-Green-Blue (RGB) [@stauffer2015somewhere]. This color space was 
developed to generate color on computer screens not in corresponds to human 
perception of color [@zeileis2009escaping]. Zeileis, Hornik, and Murrell further 
...
HCL, short for Hue-Chroma-Luminance, was developed to overcome many problems 
encountered by other color spaces. Developed based on human perception of
color, this color space 

To overcome the limitations presented by RGB and HSV color space, a perceptual-
based color space was developed: Hue-Chorma-Luminance (HCL). Hue corresponds to 
dominant wavelength, chroma to colourfulness, luminance to brightness 
[@ihaka2003colour].
